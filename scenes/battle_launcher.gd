...
#
#
## 	# Set up the decks for battling
	#print("Battle instance created.")
	#if player_deck_to_load.is_empty() or opponent_deck_to_load.is_empty():
		#printerr("BattleLauncher: Decks not initialized!")
		#opponent_deck_to_load = [_unmake_res, _taunting_elf_res, _scavenger_ghoul_res, _unmake_res]
		#player_deck_to_load = [_river_efreet_res, _reassembling_legion_res, _superior_intellect_res, _reanimate_res]
